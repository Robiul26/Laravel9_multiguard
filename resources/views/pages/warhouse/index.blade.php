                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Warhouse</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Warhouse List</h3>
                                            ...
                                            @foreach ($warhouses as $item)
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        ...
                                                        <form action="{{ route('warhouses.destroy', $item->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
                                                ...
                                                <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('warhouses.update', $item->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('PUT')
        ...
        <div class="modal fade bs-example-modal-add_data" data-backdrop="static" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('warhouses.store') }}" method="post">
                        @csrf
                        <div class="col-md-12 col-sm-12 col-12 mt-3">
